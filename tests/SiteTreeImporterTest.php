...
YML;
    ...
    public function testImportPublishAll()
    {
        $data = <<<YML
Parent1
Parent2
...
YML;
    ...
    public function testImportSkipsComments()
    {
        $data = <<<YML
# Comments are skipped
Parent1
YML;
    ...
    public function testImportWithJSON()
    {
        // create sample record
        $page = new Page();
        $page->Title = 'ShouldBeExisting';
...
YML;
    ...
    public function testDetectsDuplicatesByParent()
    {
        $page = new Page();
        $page->Title = 'MyPage';
